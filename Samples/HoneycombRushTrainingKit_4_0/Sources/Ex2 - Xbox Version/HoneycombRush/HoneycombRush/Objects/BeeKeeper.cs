...
namespace HoneycombRush
{
    ...
    public class BeeKeeper : TexturedDrawableGameComponent
    {
        ...
        Vector2 smokeAdjustment = Vector2.Zero;
        ...
        public override Rectangle Bounds
        {
            get
            {
                // No need to consider scaling, as they alter the "bodySize" member
        ...
        public override Rectangle CentralCollisionArea
        {
            get
            {
                // No need to consider scaling, as everything is "Bounds" based
...
#else
            // On the PC/Xbox, movement speed is more touchy, so we need the puffs to behave differently
            return initialVector * 5f + velocity * 0.2f;
#endif
