...
namespace HoneycombRush
{
    ...
    public class GameplayScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            {
                debugSystem.DebugCommandUI.RegisterCommand("ToggleBounds",
                    "Shows/Hides all bounds of the various game elements.", ToggleBoundDisplay);
                debugSystem.DebugCommandUI.RegisterCommand("ToggleCollisionAreas",
                    "Shows/Hides all collision areas of the various game elements.", ToggleCollisionDisplay);
        ...
        private void LoadTextures()
        {
            ...
            borderTexture = ScreenManager.Game.Content.Load<Texture2D>("Textures/square");
        ...
        private void ToggleBoundDisplay(IDebugCommandHost host, string command, IList<string> arguments)
        {
            foreach (var component in ScreenManager.Game.Components)
            {
                if (component is TexturedDrawableGameComponent)
                {
                    ...
                    texturedComponent.DrawBounds = !texturedComponent.DrawBounds;
                }
            }
        }
