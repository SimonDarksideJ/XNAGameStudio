...
#elif XBOX
        public const float BeehiveLeftMargin = 0;
        public const float BeehiveRightMargin = 0;
        public const float BeehiveTopMargin = -50;
        /// <summary>
        /// An additional offset used for positioning the bottom two beehives.
        /// </summary>
        public const float BeehiveMiddleOffset = 50;

        public const float HoneyJarTopMargin = 440;
        public const float HoneyJarLeftMargin = 265;

        public const float VatArrowOffset = -35;
        public const float VatBottomMargin = 40;
        public const int VatScorebarHeight = 15;
        public const int VatScorebarWidth = 230;

        /// <summary>
        /// The size of the smoke button.
        /// </summary>
        public const float SmokeButtonSize = 100;

        /// <summary>
        /// This margin takes the button's own size in consideration.
        /// </summary>
        public const float SmokeButtonRightAbsoluteMargin = 325;
        /// <summary>
        /// This margin takes the button's own size in consideration.
        /// </summary>
        public const float SmokeButtonBottomAbsoluteMargin = 145;

        public const float SprayUpOffset = 24;
        public const float SprayMiddleOffset = 65;
        public const float SprayDownOffset = 110;
        public const float SprayRightOffset = 230;
        public const float SprayLeftOffset = 130;

        public const float HighScorePlaceLeftMargin = 10;
        public const float HighScoreNameLeftMargin = 220;
        public const float HighScoreScoreLeftMargin = 680;
        public const float HighScoreTopMargin = 75;
        public const float HighScoreOddVerticalJump = 74;
        public const float HighScoreEvenVerticalJump = 69;
#else
        /// <summary>
