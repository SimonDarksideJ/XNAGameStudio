...
namespace HoneycombRush
{
    ...
    public class Beehive : TexturedDrawableGameComponent
    {
        ...
        public override Rectangle Bounds
        {
            get
            {
                Rectangle baseRectangle = base.Bounds;
                int width = baseRectangle.Width;
                int height = baseRectangle.Height / 3;

                return new Rectangle((int)base.Bounds.X + 4, (int)base.Bounds.Y + height + 10, width - 15, height);
            }
        }
