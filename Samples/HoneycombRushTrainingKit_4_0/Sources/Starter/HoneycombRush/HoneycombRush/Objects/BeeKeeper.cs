    ...
    public class BeeKeeper : TexturedDrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (isDepositingHoney)
            {
                ...
                AnimationDefinitions[BeekeeperDepositingHoneyAnimationKey].Draw(spriteBatch, position,
                    SpriteEffects.None);
        ...
        private void DetermineDirection(ref WalkingDirection tempDirection, ref Vector2 smokeAdjustment)
        {
            if (!VirtualThumbsticks.LeftThumbstickCenter.HasValue)
            {
                return;
            ...
            if (ThumbStickArea.Intersects(touchPointRectangle))
            {
                ...
                {
                    DetermineDirectionDominantX(ref tempDirection, ref smokeAdjustment);
                }
                else
                {
                    DetermineDirectionDominantY(ref tempDirection, ref smokeAdjustment);
                }
            }
        }
        ...
        /// <param name="smokeAdjustment">Adjustment to smoke position according to input direction.</param>
        private void DetermineDirectionDominantX(ref WalkingDirection tempDirection, ref Vector2 smokeAdjustment)
        {
        ...
        /// <param name="tempDirection">Enum describing the input direction.</param>
        /// <param name="smokeAdjustment">Adjustment to smoke position according to input direction.</param>
        private void DetermineDirectionDominantY(ref WalkingDirection tempDirection, ref Vector2 smokeAdjustment)
        {
