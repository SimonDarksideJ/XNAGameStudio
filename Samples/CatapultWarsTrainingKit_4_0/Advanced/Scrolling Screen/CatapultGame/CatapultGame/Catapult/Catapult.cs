...
namespace CatapultGame
{
    ...
    public class Catapult : DrawableGameComponent
    {
        ...
        { 
            get
            {
                return animations["Fire"].FrameSize.X;
            }
        }
        ...
        // Properties used to support the camera system
        ...
        private GameplayScreen Screen
        {
            get
            {
                return (curGame as CatapultGame).BottomScreen as GameplayScreen;
            }
        }
        #endregion
        ...
        public override void Initialize()
        {
            ...
            if (isAI)
                projectileStartPosition = Position + new Vector2(30, -8);
            else
                projectileStartPosition = Position + new Vector2(35, -8);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (currentState)
            {
                ...
                case CatapultState.Firing | CatapultState.ProjectileFlying:
                    ...
                    Screen.CenterOnPosition(projectile.ProjectilePosition);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            switch (lastUpdateState)
            {
                ...
                case CatapultState.Aiming:
                case CatapultState.Stalling:
                    animations["Aim"].Draw(spriteBatch, CorrectForCamera(Position),
                        DrawScale, spriteEffects);
                    break;
                case CatapultState.Firing:
                    animations["Fire"].Draw(spriteBatch, CorrectForCamera(Position),
                        DrawScale, spriteEffects);
                    break;
                case CatapultState.Firing | CatapultState.ProjectileFlying:
                case CatapultState.ProjectileFlying:
                ...
                case CatapultState.ProjectileHit:
                    ...
                    animations["fireMiss"].Draw(spriteBatch,
                        CorrectForCamera(projectile.ProjectileHitPosition), DrawScale, 
                        spriteEffects);
                    break;
                case CatapultState.Hit:
                    // Catapult hit animation
                    animations["Destroyed"].Draw(spriteBatch, 
                        CorrectForCamera(Position), DrawScale, spriteEffects);

                    // Projectile smoke animation
                    animations["hitSmoke"].Draw(spriteBatch, 
                        CorrectForCamera(Position), DrawScale, spriteEffects);
                    break;
                case CatapultState.Reset:
                    DrawIdleCatapult();
        ...
        /// <summary>
        /// Returns a corrected vector which places the supplied vector appropriately
        /// when considering camera settings.
        /// </summary>
        /// <param name="vector">The vector to correct.</param>
        /// <returns>The corrected vector, taking the camera zoom and offset
        /// into account.</returns>
        private Vector2 CorrectForCamera(Vector2 vector)
        {
            return vector * DrawScale + DrawOffset;
        }
        ...
        {
            spriteBatch.Draw(idleTexture, CorrectForCamera(Position), 
                null,  Color.White, 0.0f, Vector2.Zero, DrawScale, spriteEffects, 0);
        }
        #endregion
