...
namespace CatapultGame
{
    class Projectile : DrawableGameComponent
    {
        ...
        {
            UpdateProjectileFlightData((float)gameTime.ElapsedGameTime.TotalSeconds,
                wind, gravity, out groundHit);
        }

        /// <summary>
        /// Helper function - calculates the projectile position and velocity based on time.
        /// </summary>
        /// <param name="gameTime">The seconds which elapsed since the last call</param>
        public void UpdateProjectileFlightData(float elapsedSeconds, float wind, float gravity, out bool groundHit)
        {
