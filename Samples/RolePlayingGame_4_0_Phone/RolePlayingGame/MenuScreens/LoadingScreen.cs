    ...
    class LoadingScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            loadingPosition = new Vector2(
                viewport.X + (float)Math.Floor((viewport.Width - 
                    (loadingTexture.Width * ScaledVector2.DrawFactor ) ) / 2f),
                viewport.Y + (float)Math.Floor((viewport.Height - 
                    (loadingTexture.Height * ScaledVector2.DrawFactor)) / 2f));
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                spriteBatch.Draw(loadingTexture, loadingPosition,null, Color.White,0f,
                    Vector2.Zero, ScaledVector2.DrawFactor, SpriteEffects.None, 0f);
                spriteBatch.End();
            }
        }
