...
namespace RolePlaying
{
    ...
    static class Fonts
    {
        ...
        public static Vector2 GetCenterPositionInButton(SpriteFont font, string text, Rectangle buttonPosition)
        {
            ...
            positionOfText.X = (buttonPosition.X) + buttonPosition.Width * 
                ScaledVector2.DrawFactor / 2 - fontSize.X / 2;
            positionOfText.Y = buttonPosition.Y + buttonPosition.Height * 
                ScaledVector2.DrawFactor / 2 - fontSize.Y / 2;
