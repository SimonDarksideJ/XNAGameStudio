...
namespace RolePlaying
{
    class ChestScreen : InventoryScreen
    {
        ...
        private static readonly float powerColumnInterval = 300 * ScaledVector2.ScaleFactor;
        private static readonly float quantityColumnInterval = 450 * ScaledVector2.ScaleFactor;
