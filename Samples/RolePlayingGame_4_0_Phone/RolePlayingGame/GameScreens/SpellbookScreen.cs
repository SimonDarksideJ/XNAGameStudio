...
namespace RolePlaying
{
    ...
    class SpellbookScreen : ListScreen<Spell>
    {
        ...
        private readonly Vector2 spellDescriptionPosition = ScaledVector2.GetScaledVector(200, 550);
        private readonly Vector2 warningMessagePosition = ScaledVector2.GetScaledVector(200, 580);
        ...
        private float nameColumnInterval = 80 * ScaledVector2.ScaleFactor;

        private string levelColumnText = "Level";
        private float levelColumnInterval = 240 * ScaledVector2.ScaleFactor;

        private string powerColumnText = "Power (min, max)";
        private float powerColumnInterval = 110 * ScaledVector2.ScaleFactor;

        private string magicCostColumnText = "MP";
        private float magicCostColumnInterval = 380 * ScaledVector2.ScaleFactor;
