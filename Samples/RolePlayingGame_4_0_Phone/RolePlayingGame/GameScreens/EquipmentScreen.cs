...
namespace RolePlaying
{
    ...
    class EquipmentScreen : ListScreen<Equipment>
    {
        ...
        private float powerColumnInterval = 270 * ScaledVector2.ScaleFactor;

        protected string slotColumnText = "Slot";
        private float slotColumnInterval = 400 * ScaledVector2.ScaleFactor;
            ...
            bool isSelected)
        {
            ...
            powerPosition.Y -= (float)Math.Ceiling((powerTextSize.Y - 30f * ScaledVector2.DrawFactor) / 2);
