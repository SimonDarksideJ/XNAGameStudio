...
namespace RolePlaying
{
    ...
    class PlayerSelectionScreen : GameScreen
    {
        ...
        private readonly Vector2 textPosition = ScaledVector2.GetScaledVector(280f, 195f);
        private Vector2 currentTextPosition;
        private readonly Vector2 namePosition = ScaledVector2.GetScaledVector(394f, 30f);
        private Vector2 titlePosition;
        private readonly Vector2 scoreBoardPosition = ScaledVector2.GetScaledVector(972f, 235f);
        private readonly Vector2 selectButtonPosition = ScaledVector2.GetScaledVector(891f, 550f);
        private readonly Vector2 backButtonPosition = ScaledVector2.GetScaledVector(331f, 550f);
        ...
        public override void  LoadContent()
        {
            ...
            popupPosition.X -= (playerInfoScreen.Width * ScaledVector2.DrawFactor) / 2;
            popupPosition.Y -= (playerInfoScreen.Height * ScaledVector2.DrawFactor) / 2;
            ...
            selectButton = content.Load<Texture2D>(@"Textures\Buttons\rpgbtn");
            backButton = content.Load<Texture2D>(@"Textures\Buttons\rpgbtn");
            ...
            titlePosition = new Vector2(
                ...
                (viewport.Height - playerInfoScreen.Height * ScaledVector2.DrawFactor) / 2 +
                70f * ScaledVector2.ScaleFactor);
        }
        ...
        private void DrawCharacterCount()
        {
            ...
            // Draw the ScoreBoard
            spriteBatch.Draw(scoreBoard, scoreBoardPosition,null, Color.White,0f,
                Vector2.Zero, ScaledVector2.DrawFactor, SpriteEffects.None, 0f);

            position = scoreBoardPosition;
            position.X += 29 * ScaledVector2.ScaleFactor;
            position.Y += 100 * ScaledVector2.ScaleFactor;
