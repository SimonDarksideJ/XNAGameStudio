...
namespace RolePlaying
{
    ...
    class QuestLogScreen : ListScreen<Quest>
    {
        ...
        private static readonly float nameColumnInterval = 10 * ScaledVector2.ScaleFactor;

        protected string stageColumnText = "Stage";
        private static readonly float stageColumnInterval = 300 * ScaledVector2.ScaleFactor;
