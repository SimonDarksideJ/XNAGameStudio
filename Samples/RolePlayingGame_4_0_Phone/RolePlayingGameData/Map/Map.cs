    ...
    public class Map : ContentObject
    {
        ...
        public class MapReader : ContentTypeReader<Map>
        {
            protected override Map Read(ContentReader input, Map existingInstance)
            {
                ...
                {
                    LoadCombatIfNecessary(input.ContentManager, fixedCombatEntry);
                }
        ...
        public static void LoadCombatIfNecessary(ContentManager content, MapEntry<FixedCombat> fixedCombatEntry)
        {
           // if (encounterCombat)
           // {
                fixedCombatEntry.Content =
                    content.Load<FixedCombat>(
                ...
                fixedCombatEntry.MapSprite =
                    fixedCombatEntry.Content.Entries[0].Content.MapSprite.Clone() as AnimatingSprite;
        ...
        public static bool encounterCombat { get; set; }
