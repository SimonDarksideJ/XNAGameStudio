                ...
                Character existingInstance)
            {
                ...
                if (character.MapSprite != null)
                {
                    character.MapSprite.SourceOffset =
                        new Vector2(
                        character.MapSprite.SourceOffset.X - 32 * ScaledVector2.ScaleFactor,
                        character.MapSprite.SourceOffset.Y - 32 * ScaledVector2.ScaleFactor);
                }
                ...
                if (character.WalkingSprite != null)
                {
                    character.WalkingSprite.SourceOffset =
                        new Vector2(
                        character.WalkingSprite.SourceOffset.X - 32 * ScaledVector2.ScaleFactor,
                        character.WalkingSprite.SourceOffset.Y - 32 * ScaledVector2.ScaleFactor);
                }
