...
{
    /// <summary>
    /// Represents a button which reacts to user tap input.
    /// </summary>
    class Button
    {
        ...
        public Button(string text, Color textColor, SpriteFont textFont, Rectangle bounds, Color backgroundColor,
