...
namespace HoneycombRush
{
    ...
    public class SmokePuff : TexturedDrawableGameComponent
    {
        ...
        public override Rectangle CentralCollisionArea
        {
            get
            {
                int boundsWidth = (int)(texture.Width * spreadFactor * 1.5f);
                int boundsHeight = (int)(texture.Height * spreadFactor * 1.5f);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(texture, position + offset, null, Color.White, 0, drawOrigin, spreadFactor, 
